...
float **get_stucki_kernel(void){
    ...
    kernel[2][0] = 0.0, kernel[2][1] = 0.0, kernel[2][2] = 0.0, kernel[2][3] = 8.0 / 42, kernel[2][4] = 4.0 / 42;
    kernel[3][0] = 2.0 / 42, kernel[3][1] = 4.0 / 42, kernel[3][2] = 8.0 / 42, kernel[3][3] = 4.0 / 42, kernel[3][4] = 2.0 / 42;
    kernel[4][0] = 1.0 / 42, kernel[4][1] = 2.0 / 42, kernel[4][2] = 4.0 / 42, kernel[4][3] = 2.0 / 42, kernel[4][4] = 1.0 / 42;
